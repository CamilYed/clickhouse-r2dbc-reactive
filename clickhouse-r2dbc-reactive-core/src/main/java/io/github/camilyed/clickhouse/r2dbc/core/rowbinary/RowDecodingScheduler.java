...
public final class RowDecodingScheduler {
  ...
  // AdmissionGatedExecutorService: see its own top-level class file for the executor that backs
  // virtualThreads(int) above and enforces its "at most maxConcurrency in flight" contract.
}
