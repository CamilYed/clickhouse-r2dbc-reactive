 ...
 * to decide whether to wrap the response body in {@link ClickHouseLz4InputStream} before decoding.
 *
...
public enum ResponseCompression {
  ...
  /**
   * The response body is ClickHouse's own LZ4 block framing — see {@link
   * ClickHouseLz4InputStream}'s Javadoc for the exact wire format.
   */
  LZ4
}
