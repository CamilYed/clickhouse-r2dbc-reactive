 ...
 * transport-independent lifecycle rules required by a non-blocking, cancellable, bounded execution
 * path: query request representation, {@code query_id} handling, and cancellation state.
 *
