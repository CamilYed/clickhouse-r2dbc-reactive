 ...
 * RowBinaryWithNamesAndTypes} header (e.g. {@code "Nullable(Int32)"}, {@code "Array(String)"}),
 * not a Java type — see {@link DecodedResult} for why this deliberately stops short of predicting
 * a Java class per column.
 */
