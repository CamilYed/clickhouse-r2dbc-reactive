 ...
 *
 * <p>Mirrors {@code testkit.fakes.ClickHouseWireFixtures}, kept as a small module-local copy
 * rather than a shared dependency: {@code testkit} depends on {@code core}, so {@code core} cannot
 * depend back on {@code testkit} without a cycle.
 */
