...
public final class ClickHouseRowAssert
  ...
  /**
   * Asserts {@code column} is a {@link BigDecimal} numerically equal to {@code expected}, ignoring
   * scale.
   */
  ...
  /**
   * Asserts {@code column}'s decoded value is an instance of {@code type}, without checking its
   * value.
   */
  ...
  /**
   * Asserts {@code column} is a decoded {@code Array}/{@code Nested} value, equal to {@code
   * expected} in order.
   */
  ...
  /**
   * Asserts {@code column} is a decoded {@code Map} value, containing exactly {@code expected}
   * entries.
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Asserts {@code column} is a {@link BigInteger} equal to {@code expected} (for {@code
   * Int128}..{@code UInt256}).
   */
  ...
  /**
   * Asserts {@code column} is a {@link Float} within {@code offset} of {@code expected} (for {@code
   * Float32}).
   */
  ...
  /**
   * Asserts {@code column} is an {@link InetAddress} equal to {@code expected} (for {@code
   * IPv4}/{@code IPv6}).
   */
