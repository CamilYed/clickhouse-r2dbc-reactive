...
class BenchmarkPropertiesTest {
  ...
  void shouldDefaultPoolSizeToEightWhenNotConfigured() {
    // given / when
    final BenchmarkProperties properties = new BenchmarkProperties("dual", 100_000, 100_000, null);
  ...
  void shouldKeepAnExplicitlyConfiguredPoolSize() {
    // given / when
    final BenchmarkProperties properties = new BenchmarkProperties("dual", 100_000, 100_000, 32);
  ...
  void shouldDefaultBackendToDualWhenBlank() {
    // given / when
    final BenchmarkProperties properties = new BenchmarkProperties("  ", 100_000, 100_000, 8);
  ...
  void shouldDefaultRowCountsToOneHundredThousandWhenNonPositive() {
    // given / when
    final BenchmarkProperties properties = new BenchmarkProperties("dual", 0, -1, 8);
